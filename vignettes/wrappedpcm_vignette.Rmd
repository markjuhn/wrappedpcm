...
Finally we will fit a wrapped Brownian Motion model to our data. We will also fit a Brownian Motion model and compare the fits of both models to our dataset. 

```{r}
wrappedBM_fit = fitWrappedBM(phy = tree, trait = trait, bounds = c(0, 1))
